...
var msgs;
axios
  .get(`http://aserious.tplinkdns.com:8000/rest/v1/Chat`,{
    headers: {
  ...
  .then((response) => {
    for (var val of response.data) {
      var dataget = {
        ...
        sender: {
          id: val.sender_id,
          firstName: val.sender_firstname,
          lastName: val.sender_lastName,
          lastSeen: new Date(),
...
export const conversations = [
  ...
  // Chat GLM
  {
    ...
    name: "Aserious CEO",
    avatar:
      "https://lh5.googleusercontent.com/p/AF1QipPBgPobGflvgKsiiW9GnU4Lu-VEjesy2EKYriFu=w218-h218-n-k-no",
    admins: [1],
    draftMessage: "",
